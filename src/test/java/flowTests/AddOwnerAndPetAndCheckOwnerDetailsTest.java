...
public class AddOwnerAndPetAndCheckOwnerDetailsTest {
    ...
    public void shouldSeePetName() {
        findOwnersPage.shouldSeeText(findOwnersPage.getOwnerInformation().getPetListItems().get(0).getNameLabel(), pet.getName());
    }

    @Test
    public void shouldSeePetBirthDate() {
        findOwnersPage.shouldSeeText(findOwnersPage.getOwnerInformation().getPetListItems().get(0).getBirthDateLabel(), dateFormat(pet.getBirthDate()));
    }

    @Test
    public void shouldSeePetType() {
        findOwnersPage.shouldSeeText(findOwnersPage.getOwnerInformation().getPetListItems().get(0).getTypeLabel(), pet.getPetType().getPetType());
    }
