...
public class AddOwnerAndPetAndCheckOwnerDetailsTest {
    ...
    public void shouldSeePetName() {
        steps.shouldSeeText(findOwnersPage.getOwnerInformation().getPetListItems().get(0).getNameLabel(), pet.getName());
    }

    @Test
    public void shouldSeePetBirthDate() {
        steps.shouldSeeText(findOwnersPage.getOwnerInformation().getPetListItems().get(0).getBirthDateLabel(), dateFormat(pet.getBirthDate()));
    }

    @Test
    public void shouldSeePetType() {
        steps.shouldSeeText(findOwnersPage.getOwnerInformation().getPetListItems().get(0).getTypeLabel(), pet.getPetType().getPetType());
    }
